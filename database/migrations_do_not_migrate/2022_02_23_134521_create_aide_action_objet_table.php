...
class CreateAideActionObjetTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_action_objet', function (Blueprint $table) {
            $table->string('CATEGORIE', 20)->default('');
            $table->string('ID_AIDE_ACTION_OBJET', 32)->default('')->primary();
            $table->string('OBJET', 80)->default('');
    ...
    {
        Schema::dropIfExists('aide_action_objet');
    }
}
