...
class CreateAideSocieteOrigineTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_societe_origine', function (Blueprint $table) {
            $table->string('ID_AIDE_SOCIETE_ORIGINE', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_societe_origine');
    }
}
