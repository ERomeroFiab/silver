...
class CreateTlisteSocietesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tliste_societes', function (Blueprint $table) {
            $table->string('CODE_UTILISATEUR', 20)->default('')->index('CODE_UTILISATEUR');
            $table->string('ID_TLISTE_SOCIETES', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('tliste_societes');
    }
}
