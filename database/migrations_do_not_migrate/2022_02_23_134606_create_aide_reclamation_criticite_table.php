...
class CreateAideReclamationCriticiteTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_reclamation_criticite', function (Blueprint $table) {
            $table->string('CRITICITE', 25)->default('');
            $table->string('ID_AIDE_RECLAMATION_CRITICITE', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_reclamation_criticite');
    }
}
