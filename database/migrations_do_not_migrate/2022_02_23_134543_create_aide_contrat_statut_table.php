...
class CreateAideContratStatutTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_contrat_statut', function (Blueprint $table) {
            $table->string('ID_AIDE_CONTRAT_STATUT', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_contrat_statut');
    }
}
