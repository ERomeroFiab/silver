...
class CreateAideContactMailingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_contact_mailing', function (Blueprint $table) {
            $table->string('ID_AIDE_CONTACT_MAILING', 32)->default('')->primary();
            $table->string('MAILING', 20)->default('')->index('MAILING');
    ...
    {
        Schema::dropIfExists('aide_contact_mailing');
    }
}
