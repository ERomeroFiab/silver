...
class CreateAideSocieteSecteurTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_societe_secteur', function (Blueprint $table) {
            $table->string('ID_AIDE_SOCIETE_SECTEUR', 32)->default('')->primary();
            $table->string('SECTEUR', 36)->default('')->index('SECTEUR');
    ...
    {
        Schema::dropIfExists('aide_societe_secteur');
    }
}
