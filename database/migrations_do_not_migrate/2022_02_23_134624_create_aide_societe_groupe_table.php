...
class CreateAideSocieteGroupeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_societe_groupe', function (Blueprint $table) {
            $table->string('GROUPE', 35)->default('')->index('GROUPE');
            $table->string('ID_AIDE_SOCIETE_GROUPE', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_societe_groupe');
    }
}
