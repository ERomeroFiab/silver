...
class CreateAideSocieteRegionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_societe_region', function (Blueprint $table) {
            $table->string('CODE', 3)->default('')->index('CODE');
            $table->string('ID_AIDE_SOCIETE_REGION', 32)->default('')->primary();
            $table->string('LIBELLE', 35)->default('');
    ...
    {
        Schema::dropIfExists('aide_societe_region');
    }
}
