...
class CreateAideSocieteActiviteTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_societe_activite', function (Blueprint $table) {
            $table->string('ACTIVITE', 35)->default('')->index('ACTIVITE');
            $table->string('ID_AIDE_SOCIETE_ACTIVITE', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_societe_activite');
    }
}
