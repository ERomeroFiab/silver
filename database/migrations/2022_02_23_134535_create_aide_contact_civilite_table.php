...
class CreateAideContactCiviliteTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_contact_civilite', function (Blueprint $table) {
            $table->string('CIVILITE', 30)->default('')->index('CIVILITE');
            $table->string('ID_AIDE_CONTACT_CIVILITE', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_contact_civilite');
    }
}
