...
class CreateAideArticleSfamilleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_article_sfamille', function (Blueprint $table) {
            $table->string('ID_AIDE_ARTICLE_SFAMILLE', 32)->default('')->primary();
            $table->string('SFAMILLE', 25)->default('')->index('SFAMILLE');
    ...
    {
        Schema::dropIfExists('aide_article_sfamille');
    }
}
