...
class CreateAideAffaireStatutTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_affaire_statut', function (Blueprint $table) {
            $table->string('ID_AIDE_AFFAIRE_STATUT', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_affaire_statut');
    }
}
