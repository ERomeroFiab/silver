...
class CreateAideSocieteTypeadrTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_societe_typeadr', function (Blueprint $table) {
            $table->string('ID_AIDE_SOCIETE_TYPEADR', 32)->default('')->primary();
            ...
            $table->string('TYPE_ADRESSE', 25)->default('');
        });
    }
    ...
    {
        Schema::dropIfExists('aide_societe_typeadr');
    }
}
