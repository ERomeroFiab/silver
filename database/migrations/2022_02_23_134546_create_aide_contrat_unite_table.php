...
class CreateAideContratUniteTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_contrat_unite', function (Blueprint $table) {
            $table->string('ID_AIDE_CONTRAT_UNITE', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_contrat_unite');
    }
}
