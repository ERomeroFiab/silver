...
class CreateAideAffairePerteTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_affaire_perte', function (Blueprint $table) {
            $table->string('ID_AIDE_AFFAIRE_PERTE', 32)->default('')->primary();
            $table->string('MOTIF_PERTE', 40)->default('');
            $table->string('NO_GO', 15)->default('');
    ...
    {
        Schema::dropIfExists('aide_affaire_perte');
    }
}
