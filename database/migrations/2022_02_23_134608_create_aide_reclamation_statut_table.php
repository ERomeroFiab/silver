...
class CreateAideReclamationStatutTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_reclamation_statut', function (Blueprint $table) {
            $table->string('ID_AIDE_RECLAMATION_STATUT', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_reclamation_statut');
    }
}
