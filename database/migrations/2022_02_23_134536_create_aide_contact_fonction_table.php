...
class CreateAideContactFonctionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_contact_fonction', function (Blueprint $table) {
            $table->string('FONCTION', 40)->default('');
            $table->string('ID_AIDE_CONTACT_FONCTION', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_contact_fonction');
    }
}
