...
class CreateAideAffairePhaseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_affaire_phase', function (Blueprint $table) {
            $table->string('ID_AIDE_AFFAIRE_PHASE', 32)->default('')->primary();
            $table->string('PHASE', 45)->default('');
    ...
    {
        Schema::dropIfExists('aide_affaire_phase');
    }
}
