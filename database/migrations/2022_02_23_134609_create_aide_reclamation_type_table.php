...
class CreateAideReclamationTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_reclamation_type', function (Blueprint $table) {
            $table->string('ID_AIDE_RECLAMATION_TYPE', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_reclamation_type');
    }
}
