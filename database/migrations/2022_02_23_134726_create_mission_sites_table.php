...
class CreateMissionSitesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mission_sites', function (Blueprint $table) {
            $table->string('ID_MISSION_SITES', 32)->default('')->primary();
            $table->string('PID_ADRESSES', 32)->default('')->index('PID_ADRESSES');
