...
class CreateAideReclamationOrigineTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aide_reclamation_origine', function (Blueprint $table) {
            $table->string('ID_AIDE_RECLAMATION_ORIGINE', 32)->default('')->primary();
    ...
    {
        Schema::dropIfExists('aide_reclamation_origine');
    }
}
