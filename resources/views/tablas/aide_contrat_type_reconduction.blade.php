...
@section('customcss')
    <style>
        #tabla_aide_contrat_type_reconduction_filter {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>aide_contrat_type_reconduction</b></h4>
                <p>(Total: {{ count( config('tablas')['aide_contrat_type_reconduction'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-3 form-group">
                        <label>TYPE_RECONDUCTION:</label>
                        <input id="input__TYPE_RECONDUCTION" type="text" class="form-control">
                    </div>
                    <div class="col-3 form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-12" style="overflow-x: scroll;">
                        <table id="tabla_aide_contrat_type_reconduction" class="table-hover" style="width:100%;">
                            <thead>
                                <tr>
                                    <th>1 TYPE_RECONDUCTION</th>
...
@section('customjs')
    ...
    <script>
        let TABLA_AIDE_CONTRAT_TYPE_RECONDUCTION;
        $(document).ready(function() {

            TABLA_AIDE_CONTRAT_TYPE_RECONDUCTION = $('#tabla_aide_contrat_type_reconduction').DataTable({
                serverSide: true,
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_aide_contrat_type_reconduction') }}",
                    // error: function(jqXHR, ajaxOptions, thrownError) {
                    //     console.log("error: " + thrownError + "\n\n" + "status: " + jqXHR.statusText + "\n\n" + "response: "+jqXHR.responseText + "\n\n" + "options: "+ajaxOptions.responseText);
                    // },
                    data: function ( d ) {
                        d.SEARCH_BY_TYPE_RECONDUCTION           = $('#input__TYPE_RECONDUCTION').val();
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    title: "tabla aide_contrat_type_reconduction - " + new Date().toLocaleString(),
                    className: "bg-info",
                    exportOptions: {
            ...
            function newExportAction(e, dt, button, config) {
                var self = this;
                var oldStart = dt.aide_contrat_type_reconduction()[0]._iDisplayStart;
                dt.one('preXhr', function (e, s, data) {
                    // Just this once, load all data from the server...
                    data.start = 0;
                    data.length = 2147483647;
                    dt.one('preDraw', function (e, aide_contrat_type_reconduction) {
                        ...
                        dt.one('preXhr', function (e, s, data) {
                            ...
                            aide_contrat_type_reconduction._iDisplayStart = oldStart;
                            data.start = oldStart;
                        });
                ...
                // Requery the server with the new one-time export aide_contrat_type_reconduction
                dt.ajax.reload();
            }

        });
        function buscar(){
            TABLA_AIDE_CONTRAT_TYPE_RECONDUCTION.draw(); 
        }
        ...
        $( "#input__TYPE_RECONDUCTION" ).change(function() { agregar_quitar_bg_success('input__TYPE_RECONDUCTION'); });
