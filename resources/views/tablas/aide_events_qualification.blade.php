...
@section('customcss')
    <style>
        #tabla_aide_events_qualification_filter {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>aide_events_qualification</b></h4>
                <p>(Total: {{ count( config('tablas')['aide_events_qualification'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-3 form-group">
                        <label>QUALIFICATION:</label>
                        <input id="input__QUALIFICATION" type="text" class="form-control">
                    </div>
                    <div class="col-3 form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-12" style="overflow-x: scroll;">
                        <table id="tabla_aide_events_qualification" class="table-hover" style="width:100%;">
                            <thead>
                                <tr>
...
@section('customjs')
    ...
    <script>
        let TABLA_AIDE_EVENTS_QUALIFICATION;
        $(document).ready(function() {

            TABLA_AIDE_EVENTS_QUALIFICATION = $('#tabla_aide_events_qualification').DataTable({
                serverSide: true,
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_aide_events_qualification') }}",
                    // error: function(jqXHR, ajaxOptions, thrownError) {
                    //     console.log("error: " + thrownError + "\n\n" + "status: " + jqXHR.statusText + "\n\n" + "response: "+jqXHR.responseText + "\n\n" + "options: "+ajaxOptions.responseText);
                    // },
                    data: function ( d ) {  
                        d.SEARCH_BY_QUALIFICATION               = $('#input__QUALIFICATION').val();
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    title: "tabla aide_events_qualification - " + new Date().toLocaleString(),
                    className: "bg-info",
                    exportOptions: {
            ...
            function newExportAction(e, dt, button, config) {
                var self = this;
                var oldStart = dt.aide_events_qualification()[0]._iDisplayStart;
                dt.one('preXhr', function (e, s, data) {
                    // Just this once, load all data from the server...
                    data.start = 0;
                    data.length = 2147483647;
                    dt.one('preDraw', function (e, aide_events_qualification) {
                        ...
                        dt.one('preXhr', function (e, s, data) {
                            ...
                            aide_events_qualification._iDisplayStart = oldStart;
                            data.start = oldStart;
                        });
                ...
                // Requery the server with the new one-time export aide_events_qualification
                dt.ajax.reload();
            }

        });
        function buscar(){
            TABLA_AIDE_EVENTS_QUALIFICATION.draw(); 
        }
        ...
        $( "#input__QUALIFICATION" ).change(function() { agregar_quitar_bg_success('input__QUALIFICATION'); });
