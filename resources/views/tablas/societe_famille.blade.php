    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <p>(Total: {{ count( config('tablas')['societe_famille'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function newExportAction(e, dt, button, config) {
                var self = this;
                var oldStart = dt.societe_famille()[0]._iDisplayStart;
                dt.one('preXhr', function (e, s, data) {
                    // Just this once, load all data from the server...
                    data.start = 0;
                    data.length = 2147483647;
                    dt.one('preDraw', function (e, societe_famille) {
                        ...
                        dt.one('preXhr', function (e, s, data) {
                            ...
                            societe_famille._iDisplayStart = oldStart;
                            data.start = oldStart;
                        });
                ...
                // Requery the server with the new one-time export societe_famille
                dt.ajax.reload();
            }
