...
@section('customcss')
    <style>
        #tabla_aide_action_objet_filter {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>aide_action_objet</b></h4>
                <p>(Total: {{ count( config('tablas')['aide_action_objet'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-3 form-group">
                        <label>OBJET</label>
                        <input id="input__OBJET" type="text" class="form-control">
                    </div>
                    <div class="col-3 form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-12" style="overflow-x: scroll;">
                        <table id="tabla_aide_action_objet" class="table-hover" style="width:100%;">
                            <thead>
                                <tr>
                                    <th>1 CATEGORIE</th>
                                    <th>2 OBJET</th>
...
@section('customjs')
    ...
    <script>
        let TABLA_AIDE_ACTION_OBJET;
        $(document).ready(function() {

            TABLA_AIDE_ACTION_OBJET = $('#tabla_aide_action_objet').DataTable({
                serverSide: true,
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_aide_action_objet') }}",
                    // error: function(jqXHR, ajaxOptions, thrownError) {
                    //     console.log("error: " + thrownError + "\n\n" + "status: " + jqXHR.statusText + "\n\n" + "response: "+jqXHR.responseText + "\n\n" + "options: "+ajaxOptions.responseText);
                    // },
                    data: function ( d ) {
                        d.SEARCH_BY_CATEGORIE            = $('#input__CATEGORIE').val();
                        d.SEARCH_BY_OBJET                = $('#input__OBJET').val();
        ...
        $( "#input__OBJET" ).change(function() { agregar_quitar_bg_success('input__OBJET'); });
