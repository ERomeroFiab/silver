...
@section('customcss')
    <style>
        #tabla_aide_societe_typeadr_filter {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>aide_societe_typeadr</b></h4>
                <p>(Total: {{ count( config('tablas')['aide_societe_typeadr'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12" style="overflow-x: scroll;">
                        <table id="tabla_aide_societe_typeadr" class="table-hover" style="width:100%;">
                            <thead>
                                <tr>
                                    <th>1 TYPE_ADRESSE</th>
                                </tr>
                            </thead>
                            <tbody>
...
@section('customjs')
    ...
    <script>
        let TABLA_aide_societe_typeadr;
        $(document).ready(function() {

            TABLA_aide_societe_typeadr = $('#tabla_aide_societe_typeadr').DataTable({
                serverSide: true,
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_aide_societe_typeadr') }}",
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    title: "tabla aide_societe_typeadr - " + new Date().toLocaleString(),
                    className: "bg-info",
                    exportOptions: {
            ...
            function newExportAction(e, dt, button, config) {
                var self = this;
                var oldStart = dt.aide_societe_typeadr()[0]._iDisplayStart;
                dt.one('preXhr', function (e, s, data) {
                    // Just this once, load all data from the server...
                    data.start = 0;
                    data.length = 2147483647;
                    dt.one('preDraw', function (e, aide_societe_typeadr) {
                        ...
                        dt.one('preXhr', function (e, s, data) {
                            ...
                            aide_societe_typeadr._iDisplayStart = oldStart;
                            data.start = oldStart;
                        });
                ...
                // Requery the server with the new one-time export aide_societe_typeadr
                dt.ajax.reload();
            }
        ...
        //     TABLA_aide_societe_typeadr.draw();
        // });
