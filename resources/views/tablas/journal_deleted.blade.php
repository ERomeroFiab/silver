    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>journal_deleted</b></h4>
                <p>(Total: {{ count( config('tablas')['journal_deleted'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
...
@section('customjs')
    ...
    <script>
        let TABLA_journal_deleted;
        $(document).ready(function() {

            TABLA_journal_deleted = $('#tabla_journal_deleted').DataTable({
                serverSide: true,
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_journal_deleted') }}",
