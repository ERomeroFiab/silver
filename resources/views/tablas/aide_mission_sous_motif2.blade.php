...
@section('customcss')
    <style>
        #tabla_aide_mission_sous_motif2_filter {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>aide_mission_sous_motif2</b></h4>
                <p>(Total: {{ count( config('tablas')['aide_mission_sous_motif2'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-3 form-group">
                        <label>SOUS_MOTIF:</label>
                        <input id="input__SOUS_MOTIF" type="text" class="form-control">
                    </div>
                    <div class="col-3 form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-12" style="overflow-x: scroll;">
                        <table id="tabla_aide_mission_sous_motif2" class="table-hover" style="width:100%;">
                            <thead>
                                <tr>
                                    <th>1 SOUS_MOTIF</th>
...
@section('customjs')
    ...
    <script>
        let TABLA_AIDE_MISSION_SOUS_MOTIF2;
        $(document).ready(function() {

            TABLA_AIDE_MISSION_SOUS_MOTIF2 = $('#tabla_aide_mission_sous_motif2').DataTable({
                serverSide: true,
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_aide_mission_sous_motif2') }}",
                    // error: function(jqXHR, ajaxOptions, thrownError) {
                    //     console.log("error: " + thrownError + "\n\n" + "status: " + jqXHR.statusText + "\n\n" + "response: "+jqXHR.responseText + "\n\n" + "options: "+ajaxOptions.responseText);
                    // },
                    data: function ( d ) {
                        d.SEARCH_BY_SOUS_MOTIF                = $('#input__SOUS_MOTIF').val();
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    title: "tabla aide_mission_sous_motif2 - " + new Date().toLocaleString(),
                    className: "bg-info",
                    exportOptions: {
            ...
            function newExportAction(e, dt, button, config) {
                var self = this;
                var oldStart = dt.aide_mission_sous_motif2()[0]._iDisplayStart;
                dt.one('preXhr', function (e, s, data) {
                    // Just this once, load all data from the server...
                    data.start = 0;
                    data.length = 2147483647;
                    dt.one('preDraw', function (e, aide_mission_sous_motif2) {
                        ...
                        dt.one('preXhr', function (e, s, data) {
                            ...
                            aide_mission_sous_motif2._iDisplayStart = oldStart;
                            data.start = oldStart;
                        });
                ...
                // Requery the server with the new one-time export aide_mission_sous_motif2
                dt.ajax.reload();
            }

        });
        function buscar(){
            TABLA_AIDE_MISSION_SOUS_MOTIF2.draw(); 
        }
        ...
        $( "#input__SOUS_MOTIF" ).change(function() { agregar_quitar_bg_success('input__SOUS_MOTIF'); });
