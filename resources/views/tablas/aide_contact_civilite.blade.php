...
@section('customcss')
    <style>
        #tabla_aide_contact_civilite_filter {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>aide_contact_civilite</b></h4>
                <p>(Total: {{ count( config('tablas')['aide_contact_civilite'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            TABLA_aide_contact_civilite = $('#tabla_aide_contact_civilite').DataTable({
                ...
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_aide_contact_civilite') }}",
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    title: "tabla aide_contact_civilite - " + new Date().toLocaleString(),
                    className: "bg-info",
                    exportOptions: {
            ...
            function newExportAction(e, dt, button, config) {
                var self = this;
                var oldStart = dt.aide_contact_civilite()[0]._iDisplayStart;
                dt.one('preXhr', function (e, s, data) {
                    // Just this once, load all data from the server...
                    data.start = 0;
                    data.length = 2147483647;
                    dt.one('preDraw', function (e, aide_contact_civilite) {
                        ...
                        dt.one('preXhr', function (e, s, data) {
                            ...
                            aide_contact_civilite._iDisplayStart = oldStart;
                            data.start = oldStart;
                        });
                ...
                // Requery the server with the new one-time export aide_contact_civilite
                dt.ajax.reload();
            }
