...
@section('customcss')
    <style>
        #tabla_aide_renumeration_type_filter {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>aide_renumeration_type</b></h4>
                <p>(Total: {{ count( config('tablas')['aide_renumeration_type'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            TABLA_aide_renumeration_type = $('#tabla_aide_renumeration_type').DataTable({
                ...
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_aide_renumeration_type') }}",
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    title: "tabla aide_renumeration_type - " + new Date().toLocaleString(),
                    className: "bg-info",
                    exportOptions: {
            ...
            function newExportAction(e, dt, button, config) {
                var self = this;
                var oldStart = dt.aide_renumeration_type()[0]._iDisplayStart;
                dt.one('preXhr', function (e, s, data) {
                    // Just this once, load all data from the server...
                    data.start = 0;
                    data.length = 2147483647;
                    dt.one('preDraw', function (e, aide_renumeration_type) {
                        ...
                        dt.one('preXhr', function (e, s, data) {
                            ...
                            aide_renumeration_type._iDisplayStart = oldStart;
                            data.start = oldStart;
                        });
                ...
                // Requery the server with the new one-time export aide_renumeration_type
                dt.ajax.reload();
            }
