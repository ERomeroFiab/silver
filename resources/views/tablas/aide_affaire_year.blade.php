...
@section('customcss')
    <style>
        #tabla_aide_affaire_year_filter {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>aide_affaire_year</b></h4>
                <p>(Total: {{ count( config('tablas')['aide_affaire_year'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-3 form-group">
                        <label>VALUE:</label>
                        <input id="input__VALUE" type="text" class="form-control">
                    </div>
                    <div class="col-3 form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-12" style="overflow-x: scroll;">
                        <table id="tabla_aide_affaire_year" class="table-hover" style="width:100%;">
                            <thead>
                                <tr>
                                    <th>1 VALUE</th>
...
@section('customjs')
    ...
    <script>
        let TABLA_AIDE_AFFAIRE_YEAR;
        $(document).ready(function() {

            TABLA_AIDE_AFFAIRE_YEAR = $('#tabla_aide_affaire_year').DataTable({
                serverSide: true,
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_aide_affaire_year') }}",
                    // error: function(jqXHR, ajaxOptions, thrownError) {
                    //     console.log("error: " + thrownError + "\n\n" + "status: " + jqXHR.statusText + "\n\n" + "response: "+jqXHR.responseText + "\n\n" + "options: "+ajaxOptions.responseText);
                    // },
                    data: function ( d ) {
                        d.SEARCH_BY_VALUE                   = $('#input__VALUE').val();
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    title: "tabla aide_affaire_year - " + new Date().toLocaleString(),
                    className: "bg-info",
                    exportOptions: {
            ...
            function newExportAction(e, dt, button, config) {
                var self = this;
                var oldStart = dt.aide_affaire_year()[0]._iDisplayStart;
                dt.one('preXhr', function (e, s, data) {
                    // Just this once, load all data from the server...
                    data.start = 0;
                    data.length = 2147483647;
                    dt.one('preDraw', function (e, aide_affaire_year) {
                        ...
                        dt.one('preXhr', function (e, s, data) {
                            ...
                            aide_affaire_year._iDisplayStart = oldStart;
                            data.start = oldStart;
                        });
                ...
                // Requery the server with the new one-time export aide_affaire_year
                dt.ajax.reload();
            }

        });
        function buscar(){
            TABLA_AIDE_AFFAIRE_YEAR.draw(); 
        }
        ...
        $( "#input__VALUE" ).change(function() { agregar_quitar_bg_success('input__VALUE'); });
