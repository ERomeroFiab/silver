...
@section('customcss')
    <style>
        #tabla_aide_contact_fonction_filter {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>aide_contact_fonction</b></h4>
                <p>(Total: {{ count( config('tablas')['aide_contact_fonction'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-12" style="overflow-x: scroll;">
                        <table id="tabla_aide_contact_fonction" class="table-hover" style="width:100%;">
                            <thead>
                                <tr>
                                    <th>1 FONCTION</th>
                                    <th>2 SERVICE</th>
...
@section('customjs')
    ...
    <script>
        let TABLA_AIDE_CONTACT_FONCTION;
        $(document).ready(function() {

            TABLA_AIDE_CONTACT_FONCTION = $('#tabla_aide_contact_fonction').DataTable({
                serverSide: true,
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_aide_contact_fonction') }}",
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    title: "tabla aide_contact_fonction - " + new Date().toLocaleString(),
                    className: "bg-info",
                    exportOptions: {
            ...
            function newExportAction(e, dt, button, config) {
                var self = this;
                var oldStart = dt.aide_contact_fonction()[0]._iDisplayStart;
                dt.one('preXhr', function (e, s, data) {
                    // Just this once, load all data from the server...
                    data.start = 0;
                    data.length = 2147483647;
                    dt.one('preDraw', function (e, aide_contact_fonction) {
                        ...
                        dt.one('preXhr', function (e, s, data) {
                            ...
                            aide_contact_fonction._iDisplayStart = oldStart;
                            data.start = oldStart;
                        });
                ...
                // Requery the server with the new one-time export aide_contact_fonction
                dt.ajax.reload();
            }

        });
        function buscar(){
            TABLA_AIDE_CONTACT_FONCTION.draw(); 
        }
