...
@section('customcss')
    <style>
        #tabla_aide_mission_motif_filter {
            display: none;
        }
    </style>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="my-0">Tabla: <b>aide_mission_motif</b></h4>
                <p>(Total: {{ count( config('tablas')['aide_mission_motif'] ) }} columnas)</p>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12" style="overflow-x: scroll;">
                        <table id="tabla_aide_mission_motif" class="table-hover" style="width:100%;">
                            <thead>
                                <tr>
                                    <th>1 FAMILLE</th>
                                    <th>2 MOTIF</th>
...
@section('customjs')
    ...
    <script>
        let TABLA_aide_mission_motif;
        $(document).ready(function() {

            TABLA_aide_mission_motif = $('#tabla_aide_mission_motif').DataTable({
                serverSide: true,
                processing: true,
                ajax: {
                    url: "{{ route('get_tabla_aide_mission_motif') }}",
